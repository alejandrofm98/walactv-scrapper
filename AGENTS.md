...
- **Entry points**: `scripts/main.py` (scraper principal), `scripts/sync_iptv.py` (sync IPTV),
  ...
  `scripts/scrape_cinemeta_catalog.py` (importación autónoma de catálogos Cinemeta),
...
- **Horarios**: main.py (08:00 diario), sync_iptv.py (cada 6h), sync_replays.py (12:00 diario), metadata TMDB IPTV (03:30, 09:30, 15:30, 21:30), importación Cinemeta (01:15 diario), sinopsis Cinemeta (cada 6h), IntroDB (07:00 diario, opt-in).
